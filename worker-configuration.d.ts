/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: afd61c5ae34ff8e80b132e41e9c1c996)
...
interface __BaseEnv_Env {
	...
	HTL_ENGINE: DurableObjectNamespace<import("./src/worker").HtlEngine>;
	OANDA_ENGINE: Fetcher /* oanda-28pair-strategy */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "HtlEngine";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OANDA_ACCOUNT_ID" | "OANDA_API_KEY" | "CTE_ACCESS_TOKEN">> {}
}
