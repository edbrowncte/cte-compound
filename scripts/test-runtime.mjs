...
const sourceUrl=new URL("./test-runtime-base.mjs",import.meta.url),generatedUrl=new URL("./.test-runtime-generated.mjs",import.meta.url);
...
source=source.replace(marker,'const engineSource=(await Promise.all(["../src/engine.js","../src/engine-horizon-base.js","../src/engine-base.js"].map(path=>readFile(new URL(path,import.meta.url),"utf8")))).join("\\n");\n'+marker);
