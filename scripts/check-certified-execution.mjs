...
if(!directExport&&!ioExport&&!ioUnitsExport&&!ioDualExport&&!closeRetryExport&&!signalProvenanceExport)throw new Error("Missing Worker Durable Object certified execution export");
if(ioExport||ioUnitsExport||ioDualExport||closeRetryExport||signalProvenanceExport){
...
if(ioUnitsExport||ioDualExport||closeRetryExport||signalProvenanceExport){
...
if(ioDualExport||closeRetryExport||signalProvenanceExport){
...
if(closeRetryExport||signalProvenanceExport){
