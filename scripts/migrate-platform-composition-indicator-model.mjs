...
`    renderDecisionCandidates();\n    queueModelContextPublish();\n  }\n\n  function dateRange`,
"publish forecast model context");
...
`el("optimizerServerStatus").textContent=\`v7 · 5,000-bar target · ${state.autoConfigurations.size} / ${INSTRUMENTS.length*TIMEFRAMES.length} datasets\`;`,
"optimizer history UI");
