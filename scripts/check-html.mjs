...
if(!html.includes("asset[index]=active.price")&&!html.includes("const assetAt="))throw new Error("Missing causal HTL Asset construction path.");
...
console.log("HTML structure, causal HTL chart path, independent HTL loading, bounded candle concurrency, TEST connection, and syntax verified.");
