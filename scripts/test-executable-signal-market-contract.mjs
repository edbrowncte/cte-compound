...
console.log("Executable-signal contract verified: three IO tickets retain monotonic event chronology, manual account actions never re-arm an old event, each genuinely new selected automatic signal gets one immediate ASK/BID attempt, and the selected chart streams a forming candle plus executable BUY/SELL arrows.");
