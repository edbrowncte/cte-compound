...
export const __liveSignalPriceTest=Object.freeze({LIVE_SIGNAL_PRICE_VERSION,AUTOMATIC_SIGNAL_EXECUTION_VERSION,PRICE_BASIS,IO_MARKET_SCAN_MAX_MS,SIGNAL_ATTEMPT_LIMIT,executableSignalQuote,deduplicateLedgerPayload,quoteUnavailable,ioMarketScanCadenceMs,eventObservedAt,signalAttemptId,priorSignalAttempt,beginSignalAttempt,finishSignalAttempt});
